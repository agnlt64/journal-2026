            ...
            <DialogContent className="max-w-lg w-[90vw] bg-[rgba(5,5,8,0.95)] border border-[rgba(0,245,255,0.2)] rounded-2xl shadow-[0_0_60px_rgba(0,0,0,0.8),0_0_30px_rgba(0,245,255,0.1)]">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 pt-6">
                    <div className="flex flex-col gap-3">
                        <Label className="text-[10px] text-[rgba(0,245,255,0.6)] uppercase tracking-[0.2em]">Intensité du Flou (Défaut)</Label>
                        <Input type="number" {...register("blurLevel", { valueAsNumber: true })} className="rounded-xl bg-[rgba(255,255,255,0.03)] border-[rgba(255,255,255,0.08)] text-white" />
                    </div>

                    <div className="flex flex-col gap-3">
                        <Label className="text-[10px] text-[rgba(0,245,255,0.6)] uppercase tracking-[0.2em]">Éléments par Page</Label>
                        <Input type="number" {...register("itemsPerPage", { valueAsNumber: true })} className="rounded-xl bg-[rgba(255,255,255,0.03)] border-[rgba(255,255,255,0.08)] text-white" />
                    </div>

                    <div className="flex flex-col gap-3">
                        <Label className="text-[10px] text-[rgba(0,245,255,0.6)] uppercase tracking-[0.2em]">Code PIN Global (4 caractères)</Label>
                        <Input
                            type="text"
                            maxLength={4}
                            placeholder="****"
                    ...
                    <div className="flex justify-end gap-2 border-t border-[rgba(255,255,255,0.05)] pt-6">
                        <Button type="submit" disabled={loading} className="rounded-xl h-10 px-6 bg-[rgba(0,245,255,0.15)] text-[#00f5ff] border border-[rgba(0,245,255,0.4)] hover:bg-[rgba(0,245,255,0.25)] hover:shadow-[0_0_30px_rgba(0,245,255,0.2)] transition-all duration-300 tracking-wider">ENREGISTRER</Button>
                    </div>
                </form>
            </DialogContent>
        </Dialog>
