          ...
          <div className="grid grid-cols-2 gap-4 border-t border-[rgba(255,255,255,0.05)] pt-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                value={
                  wakeTime
                    ? `${String(new Date(wakeTime).getHours()).padStart(2, "0")}:${String(new Date(wakeTime).getMinutes()).padStart(2, "0")}`
                    : ""
                }
                onChange={(e) => {
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={
                  sleepTime
                    ? `${String(new Date(sleepTime).getHours()).padStart(2, "0")}:${String(new Date(sleepTime).getMinutes()).padStart(2, "0")}`
                    : ""
                }
                onChange={(e) => {
                  const [h, m] = e.target.value.split(":");
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)]">
              ...
              <Label
                htmlFor="sport"
                className="text-white flex items-center gap-2 cursor-pointer text-sm"
              >
